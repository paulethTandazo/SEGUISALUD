...
function Tab1Page_div_15_Template(rf, ctx) {
  if (rf & 1) {
...
function Tab1Page_div_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "h3");
...
_Tab1Page.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Tab1Page, selectors: [["app-tab1"]], decls: 56, vars: 6, consts: [[1, "ion-no-border", 3, "translucent"], [1, "header-container"], [1, "text-content"], [1, "greeting"], [1, "user-name"], [1, "streak-badge"], ["name", "flame", "color", "warning"], [1, "bg-light", "ion-padding", 3, "fullscreen"], [1, "status-card", "animate-up"], [1, "status-content"], [4, "ngIf"], ["size", "small", "color", "light", 3, "click"], ["src", "https://cdn-icons-png.flaticon.com/512/3063/3063822.png", "alt", "doctor", 1, "status-img"], [1, "section-title"], [1, "ion-no-padding"], ["size", "6"], [1, "action-card", "animate-up", "delay-1", 3, "click"], [1, "icon-box", "blue"], ["name", "calendar-number-outline"], [1, "card-title"], [1, "card-desc"], [1, "action-card", "animate-up", "delay-2", 3, "click"], [1, "icon-box", "green"], ["name", "map-outline"], [1, "action-card", "animate-up", "delay-3", 3, "click"], [1, "icon-box", "orange"], ["name", "medkit-outline"], [1, "action-card", "animate-up", "delay-4", 3, "click"], [1, "icon-box", "red"], ["name", "heart-circle-outline"]], template: function Tab1Page_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-header", 0)(1, "ion-toolbar")(2, "div", 1)(3, "div", 2)(4, "p", 3);
    ...
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(12, "ion-content", 7)(13, "div", 8)(14, "div", 9);
    \u0275\u0275template(15, Tab1Page_div_15_Template, 8, 1, "div", 10)(16, Tab1Page_div_16_Template, 5, 0, "div", 10);
    \u0275\u0275elementStart(17, "ion-button", 11);
    \u0275\u0275listener("click", function Tab1Page_Template_ion_button_click_17_listener() {
    ...
    \u0275\u0275element(19, "img", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "h3", 13);
    \u0275\u0275text(21, "Acciones R\xE1pidas");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "ion-grid", 14)(23, "ion-row")(24, "ion-col", 15)(25, "div", 16);
    \u0275\u0275listener("click", function Tab1Page_Template_div_click_25_listener() {
      return ctx.irA("/tabs/tab2");
    });
    \u0275\u0275elementStart(26, "div", 17);
    \u0275\u0275element(27, "ion-icon", 18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "span", 19);
    \u0275\u0275text(29, "Calendario");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "span", 20);
    \u0275\u0275text(31, "Citas y recordatorios");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(32, "ion-col", 15)(33, "div", 21);
    \u0275\u0275listener("click", function Tab1Page_Template_div_click_33_listener() {
      return ctx.irA("/tabs/tab4");
    });
    \u0275\u0275elementStart(34, "div", 22);
    \u0275\u0275element(35, "ion-icon", 23);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "span", 19);
    \u0275\u0275text(37, "Farmacias");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "span", 20);
    \u0275\u0275text(39, "Cerca de ti");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(40, "ion-col", 15)(41, "div", 24);
    \u0275\u0275listener("click", function Tab1Page_Template_div_click_41_listener() {
    ...
    \u0275\u0275text(45, "Botiqu\xEDn");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "span", 20);
    \u0275\u0275text(47, "Gestionar medicinas");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(48, "ion-col", 15)(49, "div", 27);
    \u0275\u0275listener("click", function Tab1Page_Template_div_click_49_listener() {
      return ctx.irA("/tabs/tab6");
    });
    \u0275\u0275elementStart(50, "div", 28);
    \u0275\u0275element(51, "ion-icon", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "span", 19);
    \u0275\u0275text(53, "Bienestar");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "span", 20);
    \u0275\u0275text(55, "Reportar estado");
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    \u0275\u0275property("translucent", true);
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate(ctx.rachaActual);
    \u0275\u0275advance();
...
//# sourceMappingURL=tab1.page-EOHAOK3I.js.map
